...
import { Target, AlertTriangle, CheckCircle, Plus, Flame, Clock, Edit2, Trash2, X } from 'lucide-react';
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="p-1 text-slate-400 hover:text-indigo-500 opacity-0 group-hover:opacity-100 transition"
                  >
